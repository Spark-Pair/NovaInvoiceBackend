...
const invoiceSchema = new mongoose.Schema(
  {
    ...
    fbrStatus: {
      type: String,
      enum: ["not_sent", "valid", "invalid", "submitted", "failed"],
      default: "not_sent",
    },
    fbrEnvironment: {
      type: String,
    ...
    fbrScenarioId: { type: String },
    fbrInvoiceNumber: { type: String },
    fbrResponse: { type: mongoose.Schema.Types.Mixed },
    fbrValidatedAt: { type: Date },
    fbrSubmittedAt: { type: Date },
